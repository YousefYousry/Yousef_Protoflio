...
import { 
  ...
  BarChart3, CheckCircle2, LayoutDashboard, DollarSign, Clock, Github 
} from "lucide-react";
...
export default function ProjectHealthcare({ onBack }: ProjectHealthcareProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pb-24 animate-in fade-in duration-700 font-sans text-slate-950 dark:text-slate-50 text-left" dir="ltr">
      ...
      {/* 2. Main Content Grid - Fixed Layout */}
      <div className="grid lg:grid-cols-12 gap-8 mb-20 items-start">
        
        {/* Left Column (Overview & Small Cards) */}
        <div className="lg:col-span-7 space-y-8 flex flex-col">
          <Card className="p-10 border border-black/5 bg-white/40 dark:bg-black/20 backdrop-blur-3xl rounded-[2.5rem] shadow-sm">
            <div className="space-y-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed italic tracking-wide">
        ...
        {/* Right Column (Repository FIRST, then Insights) */}
        <div className="lg:col-span-5 flex flex-col gap-8">
          
          {/* GitHub Repository - Now at the Top */}
          <Card className="p-10 border border-black/5 bg-white/40 dark:bg-black/20 backdrop-blur-3xl rounded-[2.5rem] flex flex-col items-center text-center space-y-6 shadow-sm group hover:border-blue-600/20 transition-all">
            ...
            <Button 
              onClick={() => window.open("https://github.com/YousefYousry/Healthcare-Clinical-Revenue-Analytics-Dashboard", "_blank")}
          ...
          {/* Strategic Objective & Key Findings */}
            ...
            <div className="relative z-10">
              <div className="space-y-4">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed italic font-medium">
                  Empowering hospital management with data-driven insights to reduce operational costs and enhance revenue cycle management.
                </p>
              </div>
